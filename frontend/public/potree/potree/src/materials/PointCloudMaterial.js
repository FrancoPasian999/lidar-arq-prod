...
export class PointCloudMaterial extends THREE.RawShaderMaterial {
	...
	constructor (parameters = {}) {
		...
		this.uniforms = {
			...
			uFilterIds: { type: "fv", value: new Float32Array(32) },
			uFilterIdsCount: { type: "i", value: 0 },
		};
	...
	get filterIds () {
		return this.uniforms.uFilterIds.value;
	}

	set filterIds (value) {
		this.uniforms.uFilterIds.value = value;
	}

	get filterIdsCount () {
		return this.uniforms.uFilterIdsCount.value;
	}

	set filterIdsCount (value) {
		this.uniforms.uFilterIdsCount.value = value;
	}
	...
	updateShaderSource () {
		...
		console.log(`Shader Filter Status: ${vs.includes("uFilterIds")}`);
